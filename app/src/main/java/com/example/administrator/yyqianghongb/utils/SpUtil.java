...
public class SpUtil {
    ...
    public static <K extends String, V extends String> Map<K, V> getMapStr(Context context,
                                                                                    String key)
    {
        try {
            return (Map<K, V>) get(context, key);
