...
public class ShapeRelativeLayout extends RelativeLayout {
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.ShapeRelativeLayout);

        shapeType = typedArray.getInt(R.styleable.ShapeRelativeLayout_shapeType_r, GradientDrawable.RECTANGLE);

        solidColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_solidColor_r, defaultColor);

        selectorPressedColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_selectorPressedColor_r, defaultSelectorColor);
        selectorDisableColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_selectorDisableColor_r, defaultSelectorColor);
        selectorNormalColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_selectorNormalColor_r, defaultSelectorColor);

        cornersRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_cornersRadius_r, 0);
        cornersTopLeftRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_cornersTopLeftRadius_r, 0);
        cornersTopRightRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_cornersTopRightRadius_r, 0);
        cornersBottomLeftRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_cornersBottomLeftRadius_r, 0);
        cornersBottomRightRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_cornersBottomRightRadius_r, 0);

        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_strokeWidth_r, 0);
        strokeDashWidth = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_strokeDashWidth_r, 0);
        strokeDashGap = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_strokeDashGap_r, 0);

        strokeColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_strokeColor_r, defaultColor);

        sizeWidth = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_sizeWidth_s_r, 0);
        sizeHeight = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_sizeHeight_s_r, dip2px(mContext, 0));

        gradientAngle = (int) typedArray.getFloat(R.styleable.ShapeRelativeLayout_gradientAngle_r, -1);
        gradientCenterX = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_gradientCenterX_r, 0);
        gradientCenterY = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_gradientCenterY_r, 0);
        gradientGradientRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_gradientGradientRadius_r, 0);

        gradientStartColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_gradientStartColor_r, -1);
        gradientCenterColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_gradientCenterColor_r, -1);
        gradientEndColor = typedArray.getColor(R.styleable.ShapeRelativeLayout_gradientEndColor_r, -1);

        gradientType = typedArray.getInt(R.styleable.ShapeRelativeLayout_gradientType_r, linear);
        gradientUseLevel = typedArray.getBoolean(R.styleable.ShapeRelativeLayout_gradientUseLevel_r, false);

        useSelector = typedArray.getBoolean(R.styleable.ShapeRelativeLayout_useSelector_r, false);
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setTextGravity(int gravity) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSelectorPressedColor(int color) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSelectorNormalColor(int color) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSelectorDisableColor(int color) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSolidColor(int color) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeStrokeWidth(int strokeWidth) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeStrokeColor(int strokeColor) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeStrokeDashWidth(float strokeDashWidth) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeStrokeDashGap(float strokeDashGap) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeCornersRadius(float radius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeCornersTopLeftRadius(float radius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeCornersTopRightRadius(float radius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeCornersBottomLeftRadius(float radius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeCornersBottomRightRadius(float radius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSizeWidth(int sizeWidth) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeSizeHeight(int sizeHeight) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientAngle(int gradientAngle) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientCenterX(int gradientCenterX) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientCenterY(int gradientCenterY) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientGradientRadius(int gradientGradientRadius) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientStartColor(int gradientStartColor) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientCenterColor(int gradientCenterColor) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientEndColor(int gradientEndColor) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientType(int gradientType) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeGradientUseLevel(boolean gradientUseLevel) {
     ...
     * @return 对象
     */
    public ShapeRelativeLayout setShapeUseSelector(boolean useSelector) {
